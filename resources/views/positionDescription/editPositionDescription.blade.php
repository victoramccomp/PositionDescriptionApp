...
<form id="formdep">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="d-flex align-items-center mt-5 mb-3 col-md-12">

        <h2>Informações da Posição</h2>
    ...
    <div class="row">
      ...
      <div class="input-group mb-3 col-md-6">
        <div class="input-group-prepend">
          <div class="input-group-text">
            <input id="interviewed-leader" name="interviewed" type="radio" value="leader" class="interviewed" required disabled>
          </div>
        </div>
      ...
      <div class="input-group mb-3 col-md-6">
        <div class="input-group-prepend">
          <div class="input-group-text">
            <input id="interviewed-colaborator" name="interviewed" type="radio" value="colaborator" class="interviewed" required disabled>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="input-group mb-3 autocomplete col-md-12">
        ...
        <input id="position" autocomplete="off" class="position form-control" type="text" name="position" data-type="position" required disabled>
      </div>
  ...
  {{-- <div class="container">
    <div class="row">
      <div class="input-group mb-3 mt-5 col-md-12">
        ...
        <input id="isactivated" name="isactivated" type="checkbox" class="isactivated" required>
      </div>
    </div>
  </div> --}}

  {{-- form submit --}}
  <button type="submit" class="btn btn-primary mb-5 mt-3 mr-auto ml-auto d-block">Salvar</button>
