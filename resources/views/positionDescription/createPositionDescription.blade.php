  ...
  <div class="container">
      ...
      <div class="input-group mb-3 col-md-6">
        <div class="input-group-prepend">
          <div class="input-group-text">
            <input id="interviewed-leader" name="interviewed" type="radio" value="leader" required>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="input-group mb-3 autocomplete col-md-12">
        ...
        {{-- <div class="input-group-append">
          <button class="btn btn-primary search-position">Pesquisar</button>
        </div> --}}
      </div>
    ...
    <div class="row">
      ...
      <div class="input-group mb-3 col-md-4">
        <div class="input-group-prepend">
          <div class="input-group-text">
            <input id="yes-allowhomeoffice" class="allowhomeoffice" name="allowhomeoffice" type="radio" value="0" checked>
          </div>
        </div>
