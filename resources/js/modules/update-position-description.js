const init = () => {
    ...
    const validPath = () => {
        const routes = ['/positiondescription/edit']
    ...
    function savePositionDescription(event) {
        ...
        var positionData = {
            id: form.querySelector('.positiondescriptionid').value,
            ...
            isactivated: form.querySelector('.switch').checked
        };
        ...
        $.ajax({
            method: 'POST',
            url: "/positiondescription/update",
            dataType: 'json',
            data: data,
            beforeSend: function () {
    ...
    function formFillPositionDescriptions(depPositionDescription) {
        ...
        document.querySelector(".positiondescriptionid").value = depPositionDescription.id;
        document.querySelector(".interviewed[value='" + depPositionDescription.interviewed + "']").checked = true;
        ...
        if (depPositionDescription.is_activated != 0) {
