const init = () => {
    ...
    const validPath = () => {
        const routes = ['/positiondescription/create']
    ...
    function searchPosition(event) {
        ...
        var positionID = document.querySelector('.position-id').value;
        var interviewedText = document.querySelector('input[name="interviewed"]:checked').value;

        console.log({
            position_id: positionID,
            interviewed: interviewedText
        })

        $.ajax({
            method: 'POST',
            url: '/positiondescription',
            dataType: 'json',
            data: {
                position_id: positionID,
                interviewed: interviewedText
            ...
            success: function (response) {
                ...
                // if (!response.found) return alert('Não foi encontrada está posição, do tipo selecionado');
    ...
    // document.querySelector('.search-position').addEventListener('click', searchPosition); // adiciona pesquisa no click da posição
